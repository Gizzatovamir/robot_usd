...
class ImageSubscriber(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            Image,
            '/rgb',  # Replace with your topic name
            self.image_callback,
            1  # Queue size of 1
        )
        ...
        self.image_repub = self.create_publisher(Image, '/res_img', 10)
        ...
        self.r = None
        self.d = None
        self.distortion_model: str = None
    ...
    def camera_info_callback(self, msg: CameraInfo):
        ...
        self.get_logger().info(f'Got camera info - {msg}')
    ...
    def process_image(self, img):
        ...
        H,L,S = self.convert2hls(undistort)
